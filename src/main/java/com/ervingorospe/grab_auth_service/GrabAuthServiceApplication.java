package com.ervingorospe.grab_auth_service;
...
public class GrabAuthServiceApplication {
...
//			System.setProperty("PORT", dotenv.get("PORT_AUTH_SERVICE"));
//		} else {
...
//			System.setProperty("PORT", System.getenv("PORT_AUTH_SERVICE"));
//		}
